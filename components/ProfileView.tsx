...
import { Copy, CheckCircle, Zap, ShieldCheck, Heart, Smile, Shield, Plus, Check, Image as ImageIcon, Lock, Settings2, Trash2, X, Edit3, Save, Camera } from 'lucide-react';
    ...
    <div className="flex flex-col animate-in fade-in duration-500 pb-10 bg-slate-950 min-h-full">
      <div className="px-4 py-20 flex flex-col items-center relative overflow-hidden">
        ...
        <div className="relative group/avatar">
          ...
          {/* BOTÃO "+" NO CANTO (Exclusivo Premium) */}
          {isPremium && !isEditing && (
        ...
        <div className="mt-14 text-center">
          <h2 className="text-4xl font-black tracking-tighter uppercase italic text-white leading-none mb-4">
        ...
        <p className="mt-16 px-12 text-slate-500 text-center text-[15px] font-medium italic opacity-80 leading-relaxed max-w-sm">
          "{profile?.about || "Navegando de forma soberana na rede descentralizada Nostr."}"
        </p>

        {/* PROMOÇÃO PREMIUM */}
        {!isPremium && (
          <div className="mt-20 w-full max-w-sm bg-gradient-to-br from-blue-600/30 via-slate-900/50 to-slate-900/80 border border-blue-500/30 p-10 rounded-[3rem] text-center shadow-2xl relative overflow-hidden">
